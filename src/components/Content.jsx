...
const Content = () => {
    ...
    return (
        <div className="content_container">
            <div id="section1" className="content_1"></div>
            <img id="section2" className="img_1"/>
            <div id="section3" className="point_box">
                <span></span>
            </div>
                ...
                <div className="img_container">
                    <div className="img_link">
                        <div className="link_div">
                            <a href="#"><img src="img1.jpg"/>인사말</a>
                        </div>
                        <div className="link_div">
                            <a href="#"><img src="img1.jpg"/>업무소개</a>
                        </div>
                        <div className="link_div">
                            <a href="#"><img src="img1.jpg"/>기장대리</a>
                        </div>
                        <div className="link_div">
                            <a href="#"><img src="img1.jpg"/>상담신청</a>
                        </div>
                        <div className="link_div">
                            <a href="#"><img src="img1.jpg"/>블로그</a>
                        </div>
                        <div className="link_div">
                            <a href="#"><img src="img1.jpg"/>오시는길</a>
                        </div>
                    </div>
                </div>
            </div>

            <div id="section4" className="point_box2"></div>
            ...
            <div id="section5" className="point_box3"></div>

            <div className="container5">
                <div className="img_3">프로세스 이미지</div>
            </div>

            <div id="section6" className="point_box4"></div>

            <div className="container4">
                <div className="img_4">고객사</div>
            </div>

            <div id="section7" className="point_box5"></div>

            <div className="container4">
                <div className="img_5">서비스이미지</div>
            </div>
            <div id="section8" className="point_box6"></div>
            <div className="container3">
                <div className="p_div2">
                    <p>Directions
                        <span
